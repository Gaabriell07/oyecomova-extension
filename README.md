...
> *Tip: Te recomendamos hacer clic en el ícono del rompecabezas 🧩 en la esquina superior derecha de tu navegador y fijar (📌) la extensión para tenerla siempre a la vista.*
...
---
*Cualquier cambio que hagamos en el código fuente (como en `background.js` o `content.js`), tendrás que volver a la página de `chrome://extensions/` y presionar el ícono de recarga 🔄 (la flecha circular en la tarjeta de OyeComoVa) para aplicar la última versión.*
